            ...
            <div class="col-lg-6">
                <div>
                    <div class="mb-3">
                        ...
                        $profileData ->name}}" id="example-text-input">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        $profileData ->email}}" id="example-text-input">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        $profileData ->phone}}" id="example-text-input">
                    </div>
            ...
            <div class="col-lg-6">
                <div class="mt-3 mt-lg-0">
                    <div class="mb-3">
                        ...
                        $profileData ->address}}" id="example-text-input">
                    </div>
