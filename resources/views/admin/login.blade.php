...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>admin Login | Minia - Minimal Admin & Dashboard Template</title>
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            <div class="d-flex align-items-start">
                                                                ...
                                                                <div class="flex-grow-1 ms-3 mb-4">
                                                                    <h5 class="font-size-18 text-white">FACHRY DWI ZAKARIA
                                                                    </h5>
                                                        ...
                                                        <div class="mt-4 pt-3 pb-5">
                                                            ...
                                                            <img src="{{asset('backend/assets/images/users/avatar-1.jpg')}}" class="avatar-md img-fluid rounded-circle" alt="...">
                                                                <div class="flex-1 ms-3 mb-4">
                                                                    <h5 class="font-size-18 text-white">FACHRY DWI ZAKARIA</h5>
